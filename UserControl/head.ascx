...
<ul class="layui-nav layui-bg-cyan">
    <li class="layui-nav-item"><asp:Label ID="dateLabel" runat="server" Style="color: #FFFFFF"></asp:Label></li>
    ...
    <li class="layui-nav-item"><label style="visibility:hidden;width:20px">########################</label></li>
    <li class="layui-nav-item"><asp:TextBox CssClass="layui-form-label" ID="txtKey" runat="server" Height="8px" BorderColor="#99ffcc"></asp:TextBox></li>
    <li class="layui-nav-item"><label style="visibility:hidden;width:20px">###</label></li>
    <li class="layui-nav-item">
        <asp:DropDownList CssClass="layui-nav" ID="ddlCategories" runat="server">
            <asp:ListItem>时事新闻</asp:ListItem>
            <asp:ListItem>环球经济</asp:ListItem>
            <asp:ListItem>军事世界</asp:ListItem>
            <asp:ListItem>科学技术</asp:ListItem>
    ...
    <li class="layui-nav-item"><label style="visibility:hidden;width:20px">##</label></li>
    <li class="layui-nav-item">
        <asp:Button CssClass="layui-btn layui-btn-normal layui-btn-radius layui-btn-sm" ID="btnSearch" runat="server" Text="搜索" Width="100px" OnClick="btnSearch_Click" />
    </li>
    <li class="layui-nav-item"><asp:HyperLink ID="HyperLink11" runat="server" NavigateUrl="~/AddUser.aspx">注册</asp:HyperLink></li>
    <li class="layui-nav-item"><asp:HyperLink ID="HyperLink12" runat="server" NavigateUrl="~/Login.aspx">登录</asp:HyperLink></li>
    <li class="layui-nav-item"><asp:HyperLink ID="HyperLink10" runat="server" NavigateUrl="~/BackDesk/Login.aspx">后台管理</asp:HyperLink></li>
</ul>
